...
#ifndef FEcoSysGenRandomConfigH
#define FEcoSysGenRandomConfigH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFormEcoSysGenRandomConfig : public TForm
{
...
public:		// User declarations
        __fastcall TFormEcoSysGenRandomConfig(TComponent* Owner);

        void SetData(EcoSysGenRandom* _data);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormEcoSysGenRandomConfig *FormEcoSysGenRandomConfig;
//---------------------------------------------------------------------------
#endif
