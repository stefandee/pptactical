...
#pragma link "CSPIN"
#pragma resource "*.dfm"
TFormEcoSysGenRandomConfig *FormEcoSysGenRandomConfig;
//---------------------------------------------------------------------------

__fastcall TFormEcoSysGenRandomConfig::TFormEcoSysGenRandomConfig(TComponent* Owner)
        : TForm(Owner)
{
  mEditData = 0;
}
...
void TFormEcoSysGenRandomConfig::DataToScreen()
{
  if (!mEditData)
  {
    return;
  ...
  cbRepeat->Checked = mEditData->GetRepeat();
...
void TFormEcoSysGenRandomConfig::ScreenToData()
{
  mEditData->SetRepeat(cbRepeat->Checked);
...
void TFormEcoSysGenRandomConfig::ItemsToScreen()
{
}
//---------------------------------------------------------------------------

void TFormEcoSysGenRandomConfig::SetData(EcoSysGenRandom* _data)
{
  mEditData = _data;
...
void __fastcall TFormEcoSysGenRandomConfig::paintZonePaint(TObject *Sender)
{
...
void __fastcall TFormEcoSysGenRandomConfig::FormShow(TObject *Sender)
{
...
void __fastcall TFormEcoSysGenRandomConfig::paintZoneMouseDown(
...
//---------------------------------------------------------------------------
void __fastcall TFormEcoSysGenRandomConfig::paintZoneMouseMove(
...
void __fastcall TFormEcoSysGenRandomConfig::paintZoneMouseUp(
      TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
      int Y)
{
...
void __fastcall TFormEcoSysGenRandomConfig::SelectAll1Click(
      TObject *Sender)
{
...
void __fastcall TFormEcoSysGenRandomConfig::LeftTopQuarter1Click(
      TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormEcoSysGenRandomConfig::LeftBottomQuarter1Click(
      TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormEcoSysGenRandomConfig::RightTopQuarter1Click(
      TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormEcoSysGenRandomConfig::RightBottomQuarter1Click(
      TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormEcoSysGenRandomConfig::DrawGridDrawCell(
...
void __fastcall TFormEcoSysGenRandomConfig::DrawGridDblClick(
      TObject *Sender)
{
  //
...
void __fastcall TFormEcoSysGenRandomConfig::Add1Click(TObject *Sender)
{
  if (OpenDialog->Execute())
  {
    EcoSysItemIn* lItem = new EcoSysItemIn();
...
//---------------------------------------------------------------------------
void __fastcall TFormEcoSysGenRandomConfig::Edit1Click(TObject *Sender)
{
  if (mItems.size() == 0)
  {
    return;
...
void __fastcall TFormEcoSysGenRandomConfig::Remove1Click(TObject *Sender)
{
  if (mItems.size() == 0)
  {
    return;
...
void __fastcall TFormEcoSysGenRandomConfig::Clear1Click(TObject *Sender)
{
  mItems.clear();
  DrawGrid->ColCount = 0;
...
void __fastcall TFormEcoSysGenRandomConfig::btnOkClick(TObject *Sender)
{
  ScreenToData();
}
//---------------------------------------------------------------------------
