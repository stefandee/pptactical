object FormEcoSysGenKernelConfig: TFormEcoSysGenKernelConfig
  Left = 295
  Top = 259
  ...
  object PopupMenu1: TPopupMenu
    ...
    object Deformationfunction1: TMenuItem
      Caption = '&Deformation function...'
      OnClick = Deformationfunction1Click
    end
  end
