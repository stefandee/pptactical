...
#ifndef PPIG_SubSysFighterWeaponsH
#define PPIG_SubSysFighterWeaponsH
//---------------------------------------------------------------------------
...
class CIGSubSysFighterWeapons : public CIGSubSysBase
{
  public: // c-d
    CIGSubSysFighterWeapons(CIGFighterUnit* _parent);
    virtual ~CIGSubSysFighterWeapons();
  ...
  private:
    int mSense, mWantedSense, mDir, mFlag;
};
